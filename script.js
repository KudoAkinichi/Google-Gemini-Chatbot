...
const API_KEY = "AIzaSyCP1enk6tUdzweCcFGXimF-0gT-trV55_4";
...
function changeTextSize(factor) {
  document.body.style.fontSize = `${
    parseFloat(getComputedStyle(document.body).fontSize) * factor
  }px`;
}
...
function toggleHighContrast() {
  ...
  document.body.style.color =
    document.body.style.color === "yellow" ? "black" : "yellow";
}
...
function toggleLightBackground() {
  document.body.style.backgroundColor =
    document.body.style.backgroundColor === "white" ? "#f4f4f4" : "white";
}
...
function resetAccessibility() {
  ...
  document
    .querySelectorAll("a")
    .forEach((link) => (link.style.textDecoration = ""));
}
